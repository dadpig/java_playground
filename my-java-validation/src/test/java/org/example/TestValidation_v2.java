...
import org.example.validation.MyBeanValidation_v2;
...
public class TestValidation_v2 {

    @Test
    public void testPersonSuccess(){
        Person p1 = new Person(8, "Mariana");
        Assertions.assertEquals(Collections.emptyList(), MyBeanValidation_v2.validate(p1));
    }

    @Test
    public void testPersonNullAge(){
        Person p2 = new Person(null, "Mariana");
        Assertions.assertEquals(Arrays.asList("age Not be Null"), MyBeanValidation_v2.validate(p2));
    }

    @Test
    public void testPersonEmptyName(){
        Person p3 = new Person(4, " ");
        Assertions.assertEquals(Arrays.asList("name Not be Empty"), MyBeanValidation_v2.validate(p3));
    }

    @Test
    public void testPersonNullAgeEmptyName(){
        Person p3 = new Person(null, " ");
        List<String>constraints = MyBeanValidation_v2.validate(p3);
